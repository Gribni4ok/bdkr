...
router.get("/teachers", async function(request,response){
    ...
    response.render("teachers/teachers.hbs", {teachers: data,title:title});
});
...
router.get("/teachers/teacher/teacher/:id", async function(request,response){
    ...
    response.render("teachers/teacher.hbs", {teacher: data.data[0], educations: data.educations,title:title});
});

router.get("/teachers/teacher/create", async function(request,response){
    const title = "Новый учитель";
    response.render("teachers/create.hbs",{title:title});
});
...
router.get("/teachers/education/create/:id",async function(request,response){
    ...
    response.render("teachers/educations/create.hbs", {teacherfio: fio, teacherID: request.params.id,title:title});
});
